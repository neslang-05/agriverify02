          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-neutral-50 border border-neutral-200">
              ...
              <p className="text-neutral-600">
                Point your camera at the seed or fertilizer and capture up to 5 images for analysis.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-neutral-50 border border-neutral-200">
              ...
              <p className="text-neutral-600">
                Our AI analyzes texture, quality, and purity patterns to detect counterfeit products.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-neutral-50 border border-neutral-200">
              ...
              <p className="text-neutral-600">
                Receive instant verification results with simple, clear recommendations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-neutral-400 text-sm">
              © 2026 AgriVerify. Protecting farmers from counterfeit products.
            </p>
          </div>
        </div>
      </footer>
