...
export function PhoneAuthDrawer({ isOpen, onClose, onSuccess }: PhoneAuthDrawerProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={handleClose}>
      <SheetContent 
        side="bottom" 
        className="h-auto max-h-[85vh] mx-auto sm:max-w-lg rounded-t-2xl border-0 px-6 pb-8"
      >
        <div className="mx-auto w-12 h-1.5 bg-neutral-300 rounded-full mt-3 mb-4" />
          ...
          {step === 'phone' && (
            <>
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full rounded-lg bg-emerald-700 hover:bg-emerald-800 h-14 text-base font-semibold"
              >
                {isLoading ? (
            ...
            <>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="123456"
                  className="text-center text-2xl tracking-widest rounded-lg h-14"
                />
              </div>
